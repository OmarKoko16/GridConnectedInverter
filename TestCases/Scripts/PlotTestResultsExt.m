...
Names2 = string(logsout2.getElementNames);
...
hold on
p(2) = plot(logsout2{Loc2Vabc}.Values.Time-Tshift,logsout2{Loc2Vabc}.Values.Data(:,1),'DisplayName',replace(logsout2{Loc2Vabc}.Values.Name, "_", "-"));
...
hold on
p(2) = plot(logsout2{Loc2Vabc}.Values.Time-Tshift,logsout2{Loc2Vabc}.Values.Data(:,2),'DisplayName',replace(logsout2{Loc2Vabc}.Values.Name, "_", "-"));
...
hold on
p(2) = plot(logsout2{Loc2Vdc}.Values.Time-Tshift,logsout2{Loc2Vdc}.Values.Data,'DisplayName',replace(logsout2{Loc2Vdc}.Values.Name, "_", "-"));
